...
import { mockCompany, mockPillars, mockGovernance, mockPressReleases } from "@/lib/mock-data";
...
export default function DemoPage() {
  ...
  // ESG Guardian component structure
  const components = [
    ...
    { type: "governance", props: { governance: mockGovernance } },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 mt-2">
              This is a demo of the ESG Guardian template. Template provided by Beacon IR.
            </p>
          </div>
        </div>
      </footer>
